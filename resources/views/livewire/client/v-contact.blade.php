    ...
    <div class="container py-5">
        <form class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="inputnom4" aria-describedby="texthelp">
              <div class="form-text" id="textHelp">Veillez bien saisir votre nom</div>
            </div>
            <div class="col-md-6">
              <label for="inputEmail4" class="form-label">Email</label>
              <input type="email" class="form-control" id="inputEmail4" aria-describedby="texthelp">
              <div class="form-text" id="textHelp">Veillez bien saisir votre email</div>
            </div>
            <div class="col-md-12">
              <label for="inputsujet" class="form-label">Sujet</label>
              <input type="text" class="form-control" id="inputsujet" aria-describedby="texthelp" >
